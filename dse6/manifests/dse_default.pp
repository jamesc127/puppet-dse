...
#
class dse6::dse_default (
  $path          = $dse6::dse_default::params::path,
  $solr_enabled  = $dse6::dse_default::params::solr_enabled,
  $spark_enabled = $dse6::dse_default::params::spark_enabled,
  $cfs_enabled   = $dse6::dse_default::params::cfs_enabled,
  $java_home     = $dse6::dse_default::params::java_home,
  $spark_home    = $dse6::dse_default::params::spark_home
) inherits dse6::dse_default::params {
  anchor { 'dse5::dse_default::begin': } ->
  class { '::dse6::dse_default::config': } ->
