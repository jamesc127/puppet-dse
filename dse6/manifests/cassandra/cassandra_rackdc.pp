...
class dse6::cassandra::cassandra_rackdc (
  $path = $dse6::cassandra::cassandra_rackdc::params::path,
  $dc = $dse6::cassandra::cassandra_rackdc::params::dc,
  $rack = $dse6::cassandra::cassandra_rackdc::params::rack,
  $dc_suffix = $dse6::cassandra::cassandra_rackdc::params::dc_suffix,
  $prefer_local = $dse6::cassandra::cassandra_rackdc::params::prefer_local
) inherits dse6::cassandra::cassandra_rackdc::params {
  anchor { 'dse6::cassandra::cassandra_rackdc::begin': } ->
  class { '::dse6::cassandra::cassandra_rackdc::config': } ->
  anchor { 'dse6::cassandra::cassandra_rackdc::end': }
}
