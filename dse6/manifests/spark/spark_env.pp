...
class dse6::spark::spark_env (
  $path                = $dse6::spark::spark_env::params::path,
  $spark_worker_memory = $dse6::spark::spark_env::params::spark_worker_memory,
  $spark_worker_cores  = $dse6::spark::spark_env::params::spark_worker_cores,
  $driver_memory       = $dse6::spark::spark_env::params::driver_memory,
  $worker_dir          = $dse6::spark::spark_env::params::worker_dir,
  $local_dirs          = $dse6::spark::spark_env::params::local_dirs,
  $worker_log_dir      = $dse6::spark::spark_env::params::worker_log_dir,
  $master_log_dir      = $dse6::spark::spark_env::params::master_log_dir,
) inherits dse6::spark::spark_env::params {
  anchor { 'dse5::spark::spark_env::begin': } ->
  class { '::dse6::spark::spark_env::config': } ->
