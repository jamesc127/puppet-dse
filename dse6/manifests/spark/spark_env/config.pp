...
#
class dse6::spark::spark_env::config inherits dse6::spark::spark_env {
  file { 'spark-env.sh' :
    ensure  => present,
    path    => $dse6::spark::spark_env::path,
    owner   => 'cassandra',
    group   => 'cassandra',
    mode    => '0644',
  ...
  file { 'spark_worker_dir':
    ...
    path    => $dse6::spark::spark_env::worker_dir,
    owner   => 'cassandra',
    group   => 'cassandra',
    mode    => '0644',
    recurse => true
  ...
  file { 'spark_master_dir':
    ...
    path    => $dse6::spark::spark_env::master_log_dir,
    owner   => 'cassandra',
    group   => 'cassandra',
    mode    => '0644',
    recurse => true
  ...
  file { 'spark_local_dirs':
    ...
    path    => $dse6::spark::spark_env::local_dirs,
    owner   => 'cassandra',
    group   => 'cassandra',
    mode    => '0644',
    recurse => true
