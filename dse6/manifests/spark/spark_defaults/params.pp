# == Class: dse5::spark::spark_defaults::params
#
# Manages DSE Spark spark-defaults.conf default parameters. These are
# consumed by dse5::spark::spark_defaults. These values should be overridden with
# parameters passed to dse5::spark::spark_defaults::config.
#
...
#
class dse6::spark::spark_defaults::params {
