...
class dse6::spark::spark_defaults (
  $path = $dse6::spark::spark_defaults::params::path,
  $hadoop_cassandra_username = $dse6::spark::spark_defaults::params::hadoop_cassandra_username,
  $hadoop_cassandra_password = $dse6::spark::spark_defaults::params::hadoop_cassandra_password,
  $cassandra_query_retry_count = $dse6::spark::spark_defaults::params::cassandra_query_retry_count,
  $cassandra_read_timeout_ms = $dse6::spark::spark_defaults::params::cassandra_read_timeout_ms
) inherits dse6::spark::spark_defaults::params {
  anchor { 'dse5::spark::spark_defaults::begin': } ->
  class { '::dse6::spark::spark_defaults::config': } ->
