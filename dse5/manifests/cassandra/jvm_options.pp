...
#
class dse5::cassandra::jvm_options (
  $path = $dse5::cassandra::jvm_options::params::path,
  $max_heap_size = $dse5::cassandra::jvm_options::params::max_heap_size,
  $heap_newsize = $dse5::cassandra::jvm_options::params::heap_newsize,
  $parallel_gc_threads = $dse5::cassandra::jvm_options::params::parallel_gc_threads,
  $conc_gc_threads = $dse5::cassandra::jvm_options::params::conc_gc_threads,
  $initiating_heap_occupancy_percent = $dse5::cassandra::jvm_options::params::initiating_heap_occupancy_percent,
  $loggc = $dse5::cassandra::jvm_options::params::loggc,
  $jna_tmpdir = $dse5::cassandra::jvm_options::params::jna_tmpdir,
  $parallel_ref_proc_enabled = $dse5::cassandra::jvm_options::params::parallel_ref_proc_enabled,
  $snappy_tmp_dir = $dse5::cassandra::jvm_options::params::snappy_tmp_dir,
  $netty_tmp_dir = $dse5::cassandra::jvm_options::params::netty_tmp_dir,
  $java_io_tmp_dir = $dse5::cassandra::jvm_options::params::java_io_tmp_dir,
  $jmx_notification_buffer_size = $dse5::cassandra::jvm_options::params::jmx_notification_buffer_size,
  $cassandra_consistent_rangemovement = $dse5::cassandra::jvm_options::params::cassandra_consistent_rangemovement,
  $cassandra_rar_buffer_size = $dse5::cassandra::jvm_options::params::cassandra_rar_buffer_size,
) inherits dse5::cassandra::jvm_options::params {
