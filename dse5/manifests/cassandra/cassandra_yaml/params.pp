# == Class: dse5::cassandra::cassandra_yaml::params
#
# Manages DSE Cassandra cassandra.yaml default parameters. These are consumed
# by dse5::cassandra::cassandra_yaml. These values should be overridden with
# parameters passed to dse5::cassandra::cassandra_yaml::config.
#
