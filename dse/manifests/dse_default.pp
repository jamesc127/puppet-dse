...
class dse::dse_default (
  ...
  $solr_enabled  = $dse::dse_default::params::solr_enabled,
  $spark_enabled = $dse::dse_default::params::spark_enabled,
  $cfs_enabled   = $dse::dse_default::params::cfs_enabled,
  $java_home     = $dse::dse_default::params::java_home,
  $spark_home    = $dse::dse_default::params::spark_home
) inherits dse::dse_default::params {
  anchor { 'dse::dse_default::begin': } ->
  class { '::dse::dse_default::config': } ->
  anchor { 'dse::dse_default::end': }
}