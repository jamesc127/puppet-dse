...
class dse::spark::spark_env (
  ...
  $spark_worker_memory = $dse::spark::spark_env::params::spark_worker_memory,
  $spark_worker_cores  = $dse::spark::spark_env::params::spark_worker_cores,
  $driver_memory       = $dse::spark::spark_env::params::driver_memory,
  $worker_dir          = $dse::spark::spark_env::params::worker_dir,
  $local_dirs          = $dse::spark::spark_env::params::local_dirs,
  $worker_log_dir      = $dse::spark::spark_env::params::worker_log_dir
) inherits dse::spark::spark_env::params {
  anchor { 'dse::spark::spark_env::begin': } ->
  class { '::dse::spark::spark_env::config': } ->
  anchor { 'dse::spark::spark_env::end': }
}
